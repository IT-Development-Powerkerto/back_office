    ...
    */
    ...
    public function query()
    {
        $data = DB::table('leads as l')
            ...
            ->select('advertiser', 'o.name as operator_name', 'c.name as client_name', 'c.whatsapp as client_wa', 'p.name as product_name', 'l.quantity as quantity', 'l.price as price', 'l.total_price as total_price','c.created_at as client_created_at', 's.name as status')
