...
class CeoController extends Controller
{
    ...
    public function WeeklyDashboard(Request $request) {
        ...
        if($day >= $user_expired){
            ...
            if(Auth::user()->role_id == 2){
                return view('ceo.WeeklyDashboard', compact(['lead_day', 'lead_week', 'lead_month', 'lead_all', 'products', 'omset_day', 'omset_week', 'omset_month', 'omset_all', 'budgeting_day', 'budgeting_week', 'budgeting_month', 'budgeting_all']))->with('lead_count', $lead_count)->with('closing_count', $closing_count)->with('quantity', $quantity)->with('user_count', $user_count)
    ...
    public function MonthlyDashboard(Request $request) {
        ...
        if($day >= $user_expired){
            ...
            if(Auth::user()->role_id == 2){
                return view('ceo.MonthlyDashboard', compact(['lead_day', 'lead_week', 'lead_month', 'lead_all', 'products', 'omset_day', 'omset_week', 'omset_month', 'omset_all', 'budgeting_day', 'budgeting_week', 'budgeting_month', 'budgeting_all']))->with('lead_count', $lead_count)->with('closing_count', $closing_count)->with('quantity', $quantity)->with('user_count', $user_count)
