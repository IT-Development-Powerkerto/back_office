...
class LeadControllerAPI extends Controller
{
    public function index(Request $request)
    {
        ...
        if($user->role_id == 1){
            $leads = Lead::whereDate('created_at', $day)->where('admin_id', $user->admin_id)->get();
            ...
            $leads = Lead::where('admin_id', $user->admin_id)->whereDate('created_at', $day)->where('user_id', $user->id)->get();
