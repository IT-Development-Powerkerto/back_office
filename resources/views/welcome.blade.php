            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
								<img class="header-logo-image asset-light" src="img/logo.png" style="width: 150px;" alt="Logo">
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Powerkerto Back Office</h1>
	                        <p class="hero-paragraph">Work Harder Is Good But Work Smarter Is Better</p>
	                        <div class="hero-cta">
								<a class="button button-primary" href="{{ route('login') }}" style="border-radius: 100px">Login</a>
							</div>
						</div>
						<div class="hero-media">
							...
							<div class="hero-media-container">
								<img class="hero-media-image asset-light" src="img/rp.jpg" style="width:500px" alt="Hero media">
							</div>

              
						</div>
          </section>
          <img class="asset-light" src="images/wave.svg" alt="Hero media">
            <footer class="site-footer has-top-divider">
                <div class="container">
                    <div class="site-footer-inner">
                        <div class="brand footer-brand">
                            <a href="#">
                  <img class="asset-light" src="img/logoputih.png" width="200px" alt="Logo">
                            </a>
                        </div>
