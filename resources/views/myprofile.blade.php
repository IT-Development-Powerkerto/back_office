						...
						<div class="container-xxl" id="kt_content_container">
											...
											<div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
												...
												<div class="d-flex flex-column">
													...
													<div class="d-flex align-items-center mb-2">
														<p class="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">{{ Auth()->user()->name }}</p>
													</div>
													<!--end::Name-->
													<!--begin::Info-->
													<div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
														...
														<!--end::Svg Icon-->{{ Auth()->user()->role->name }}</p>
                                                        <p href="#" class="d-flex align-items-center text-gray-400 text-hover-primary mb-2">
							...
							<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
								...
								<div class="card-header cursor-pointer">
									...
									<!--end::Card title-->
									<!--begin::Action-->
									<button type="submit" data-bs-toggle="modal" data-bs-target="#add-user" class="btn btn-primary btn-xs m-3 ">
										Edit Profile
									</button>
									<!--end::Action-->
								</div>
								...
								<div class="card-body p-9">
									...
									<div class="row mb-7">
										...
										<div class="col-lg-8 fv-row">
											<span class="fw-bold fs-6 text-gray-800">Powerkerto</span>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
									...
									<div class="row mb-7">
										...
										<!--begin::Col-->
										<div class="col-lg-8">
											<a href="#" class="fw-bold fs-6 text-gray-800 text-hover-primary">powerkerto.com</a>
										</div>
										<!--end::Col-->
									</div>
									<!--end::Input group-->
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-xxl d-flex flex-column flex-md-row flex-stack">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://keenthemes.com" target="_blank" class="text-muted text-hover-primary fw-bold me-2 fs-6">Powerkerto</a>
							</div>
							<!--end::Copyright-->
						</div>
						<!--end::Container-->
