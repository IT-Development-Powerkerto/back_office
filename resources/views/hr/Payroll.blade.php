							...
							<div class="card card-xl-stretch mb-5 mb-xl-8">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bolder fs-3 mb-1">Management Members Shortcut</span>
										<span class="text-muted mt-1 fw-bold fs-7">1</span>
									</h3>
									<div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover">
										...
										<a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm mx-2">
													...
													<td>
														<div class="d-flex align-items-center">
															<div class="d-flex justify-content-start flex-column">
																<a href="#" class="text-dark fw-bolder text-hover-primary fs-6">Zall</a>
																<span class="text-muted fw-bold text-muted d-block fs-7">Banyumax</span>
															</div>
														</div>
													</td>
													<td>
														<label class="text-dark fw-medium-block fs-6">zall@zall.com</label>
													</td>
													<td>
														<label class="text-dark fw-medium-block fs-6">+6281245527645</label>
													</td>
													<td>
														<label class="text-dark fw-medium-block fs-6">Corporate</label>
													</td>
													<td>
														<label class="text-dark badge badge-light-success fw-medium-block fs-7">Active</label>
													</td>
													<td>
														<label class="text-dark badge badge-light-success fw-medium-block fs-7">27 Days Left</label>
													</td>
													<td>
