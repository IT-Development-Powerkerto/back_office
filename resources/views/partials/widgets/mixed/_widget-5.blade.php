									...
									<div class="card card-l-stretch mb-xl-8">
										...
										<div class="card-header border-0 py-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bolder fs-3 mb-1">Leads</span>
												<span class="text-muted fw-bold fs-7">Latest leads</span>
											</h3>
											<div class="card-toolbar">
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
													...
													<div class="menu-item px-3">
														<div class="menu-content text-muted pb-2 px-3 fs-7 text-uppercase">Periode</div>
													</div>
													<!--end::Heading-->
													<!--begin::Menu item-->
													<div class="menu-item px-3">
										...
										<div class="card-body d-flex flex-column">
											<!--begin::Chart-->
											<div class="w5-edit d-flex flex-row justify-content-between">
