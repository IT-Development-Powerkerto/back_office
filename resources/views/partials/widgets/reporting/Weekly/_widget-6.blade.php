				...
				<div class="pb-5">
                    ...
                    <div class="row g-5 g-xl-8 mt-n 5">
                        ...
                        <div class="col-xl-4">
                            ...
                            <label class="card bg-success hoverable card-xl-stretch mb-5 mb-xl-8">
                                <!--begin::Body-->
                                <div class="card-body">
                                    <div class="text-white fw-bolder fs-4">{{($omset_week_count->sum('total_price')-$omset_week_count->sum('product_promotion')) / 1000000}} Juta</div>
					...
					<div class="pt-1">
						...
						<div class="d-flex align-items-center pb-7">
                            ...
                            <span class="fw-medium text-muted label label-xl label-light-success label-inline px-3 py-5 min-w-45px">{{($omset_week_count->where('product_name', $product->name)->sum('total_price')-$omset_week_count->where('product_name', $product->name)->sum('product_promotion')) / 1000000}} Juta</span>
							<!--end::label-->
						</div>
                        @endforeach
						<!--end::Item-->
