		...
		<div class="card shadow-sm">
			...
			<div class="card-header border-0 bg-white py-5">
				...
				<label class="my-auto px-3 rounded fs-5 fw-bolder bg-light-success text-success">{{$lead_day_count}} Lead</label>
			</div>
			<!--end::Header-->
			<!--begin::Body-->
			<div class="card-body">
                            ...
                            @foreach ($product as $product)
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div>
                                        ...
                                        <div class="font-size-sm fw-bold text-{{$icon->where('id', ($n%5 == 0) ? 5 : $n%5)->implode('name')}}">200</div>
                                    </div>
                                </div>
                                <!--end::Item-->
                            @endforeach
