				...
				<div class="pb-5">
					...
					<div class="pt-1 scroll scroll-pull" data-scroll="true" data-wheel-propagation="true" style="height: 300px">
						...
						<div class="d-flex align-items-center pb-7">
                            ...
                            <span class="fw-medium text-muted label label-xl label-light-success label-inline px-3 py-5 min-w-45px">{{round(($omset_day_count->where('product_name', $product->name)->sum('total_price')-$omset_day_count->where('product_name', $product->name)->sum('product_promotion')) / 1000000, 1)}} Juta</span>
							<!--end::label-->
						</div>
                        @endforeach
						<!--end::Item-->
