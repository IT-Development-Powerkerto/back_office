		...
		<div class="card">
			...
			<div class="card-header border-0 bg-white py-5">
				<h3 class="card-title fw-bolder text-dark">Closing Product Statistics</h3>
				<div class="card-toolbar">
					<!--begin::Menu-->
					<button type="button" class="btn btn-sm btn-icon btn-color-dark btn-active-primary btn-active-color- border-0 me-n3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-4 d-flex flex-column">
						<!--begin::Block-->
						<div class="bg-secondary p-8 rounded rounded-xl flex-grow-1">
							<!--begin::Item-->
							<div class="d-flex align-items-center mb-5">
								<div class="symbol symbol-circle symbol-white symbol-30 flex-shrink-0 me-3">
								...
								<div>
									<div class="font-size-sm font-weight-bold">Generos</div>
									<div class="font-size-sm text-muted">Total 150</div>
								</div>
							</div>
							<!--end::Item-->
							<!--begin::Item-->
							<div class="d-flex align-items-center mb-5">
								...
								<div>
									<div class="font-size-sm font-weight-bold">Etawaku</div>
									<div class="font-size-sm text-muted">Total 150</div>
								</div>
							</div>
							<!--end::Item-->
							...
							<div class="d-flex align-items-center mb-5">
								<div class="symbol symbol-circle symbol-white symbol-30 flex-shrink-0 me-3">
									<div class="symbol-label">
										<span class="svg-icon svg-icon-md svg-icon-success">
											<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Design/Flip-vertical.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24"></rect>
								...
								<div>
									<div class="font-size-sm font-weight-bold">Gizidat</div>
									<div class="font-size-sm text-muted">Total 150</div>
								</div>
							</div>
							<!--end::Item-->
							...
							<div class="d-flex align-items-center mb-5">
								<div class="symbol symbol-circle symbol-white symbol-30 flex-shrink-0 me-3">
									<div class="symbol-label">
										<span class="svg-icon svg-icon-md svg-icon-danger">
											<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Home/Cupboard.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24"></rect>
								...
								<div>
									<div class="font-size-sm font-weight-bold">Freshmag</div>
									<div class="font-size-sm text-muted">Total 150</div>
								</div>
							</div>
							<!--end::Item-->
							...
							<div class="d-flex align-items-center mb-5">
								...
								<div>
									<div class="font-size-sm font-weight-bold">Rube</div>
									<div class="font-size-sm text-muted">Total 150</div>
								</div>
							</div>
							<!--end::Item-->
					...
					<div class="col-8">
					<!--begin::Chart-->
					{{-- <div class="mixed-widget-2-chart card-rounded-bottom bg-secondary" data-kt-color1="primary" data-kt-color2="success" data-kt-color3="info" data-kt-color4="danger" data-kt-color5="warning" data-kt-color6="secondary" style="height: 100%; "></div> --}}
					<div class="card-rounded-bottom bg-secondary" id="kt_charts_widget_9_chart" style="height: 100%"></div>
					<!--end::Chart-->
				</div>
			</div>
			<!--end::Body-->
