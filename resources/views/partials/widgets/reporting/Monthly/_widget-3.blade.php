						...
						<div class="card shadow-sm card-xl-stretch mt-n5 mb-xl-8">
							...
							<div class="card-body d-flex flex-column p-0">
								<div class="d-flex flex-stack flex-grow-1 card-p">
									...
									<span class="my-auto px-3 rounded fs-5 fw-bolder bg-light-primary text-primary">{{($omset_month_count->sum('total_price')-$omset_month_count->sum('product_promotion') == 0) ? 0 : ($advertising_month_count / ($omset_month_count->sum('total_price')-$omset_month_count->sum('product_promotion')))*100}} %</span>
								</div>
