																...
																<td class="d-flex align-items-center justify-content-end mb-3">
																	...
																	<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																		...
																		<div class="menu-item px-3">
																			<a href="{{route('manager.approve', ['id' => $budgeting_adv->id])}}" class="menu-link px-3">Approve</a>
																		</div>
																		<!--end::Menu item-->
																		<!--begin::Menu item-->
																		<div class="menu-item px-3">
																			<a href="{{route('manager.reject', ['id' => $budgeting_adv->id])}}" class="menu-link px-3" >Reject</a>
															...
															<tr>
																...
																<td class="d-flex align-items-center justify-content-end mb-3">
																	...
																	<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
																		<!--begin::Menu item-->
																		<div class="menu-item px-3">
																			<a href="{{route('manager.approve', ['id' => $budgeting_nonadv->id])}}" class="menu-link px-3">Approve</a>
																		</div>
																		<!--end::Menu item-->
																		<!--begin::Menu item-->
																		<div class="menu-item px-3">
																			<a href="{{route('manager.reject', ['id' => $budgeting_nonadv->id])}}" class="menu-link px-3" >Reject</a>
																			{{-- data-kt-customer-table-filter="delete_row" --}}
																		</div>
																		<!--end::Menu item-->
																		<!--begin::Menu item-->
