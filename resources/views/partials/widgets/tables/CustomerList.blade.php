												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<select class="form-select form-select-solid fw-bolder" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-customer-table-filter="month" data-dropdown-parent="#kt-toolbar-filter">
															...
															<option value="sep">Spetember</option>
													...
													<div class="mb-10">
														<!--begin::Label-->
														<label class="form-label fs-5 fw-bold mb-3">Packet Type:</label>
														<!--end::Label-->
														<!--begin::Options-->
														<div class="d-flex flex-column flex-wrap fw-bold" data-kt-customer-table-filter="payment_type">
															...
															<label class="form-check form-check-sm form-check-custom form-check-solid mb-3 me-5">
																...
																<span class="form-check-label text-gray-600">Flexible Plan</span>
															</label>
															<!--end::Option-->
															<!--begin::Option-->
															<label class="form-check form-check-sm form-check-custom form-check-solid mb-3">
																<input class="form-check-input" type="radio" name="payment_type" value="mastercard" />
																<span class="form-check-label text-gray-600">Entrepreneur Plan</span>
															</label>
															<!--end::Option-->
															<!--begin::Option-->
															<label class="form-check form-check-sm form-check-custom form-check-solid">
																<input class="form-check-input" type="radio" name="payment_type" value="american_express" />
																<span class="form-check-label text-gray-600">Corporate Plan</span>
															</label>
															<!--end::Option-->
														</div>
														<!--end::Options-->
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
										...
										<tbody class="fw-bold text-gray-600">
											...
											<tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <label class="text-gray-600 text-hover-primary mb-1">{{$user->phone}}</label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <label class="text-gray-600 text-hover-primary mb-1">{{$user->paket->name}}</label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <label class="text-gray-600 text-hover-primary mb-1">{{$user->expired_at}}</label>
                                                    </div>
                                                </td>
                                                <td class="text-end">
