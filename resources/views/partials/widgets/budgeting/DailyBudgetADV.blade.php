                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <h1 class="text-dark fw-medium fs-6">
                                                                            <script>
                                                                                var bilangan = {{$lead_day->where('admin_id', auth()->user()->admin_id)->where('advertiser', $adv->name)->count()}};
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <h1 class="text-dark fw-medium fs-6">
                                                                            <script>
                                                                                var bilangan = {{$lead_day->where('admin_id', auth()->user()->admin_id)->where('advertiser', $adv->name)->where('status_id', 5)->count()}};
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <h1 class="text-dark fw-medium fs-6">
                                                                            <script>
                                                                                var bilangan = {{$lead_day->where('admin_id', auth()->user()->admin_id)->where('advertiser', $adv->name)->where('status_id', 5)->sum('quantity')}};
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center justify-content-end">
                                                                        <h1 class="text-dark fw-medium fs-6">Rp.
                                                                            <script>
                                                                                var bilangan = {{$omset_day->where('admin_id', auth()->user()->admin_id)->where('adv_name', $adv->name)->sum('total_price') - $omset_day->where('admin_id', auth()->user()->admin_id)->where('adv_name', $adv->name)->sum('product_promotion')}};
