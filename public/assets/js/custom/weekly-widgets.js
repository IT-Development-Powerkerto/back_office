...
var KTWidgets = function () {
    ...
    var initChartsWidget10 = function() {
        ...
        for(let i=0; i<product_count; i++){
            ...
            matchedData[i] = {
                ...
                name: document.getElementById('product ' + x).value,
                data: [
                    parseInt(document.getElementById(x + ' bottle_week1').value),
                    parseInt(document.getElementById(x + ' bottle_week2').value),
                    parseInt(document.getElementById(x + ' bottle_week3').value),
                    parseInt(document.getElementById(x + ' bottle_week4').value)
                ]
            };
            x+=1;
        }
    ...
    var initChartsWidget12 = function() {
        ...
        for(let i=0; i<product_count; i++){
            ...
            matchedData[i] = {
                ...
                name: document.getElementById('product ' + x).value,
                data: [
                    parseInt(document.getElementById(x + ' closing_week1').value),
                    parseInt(document.getElementById(x + ' closing_week2').value),
                    parseInt(document.getElementById(x + ' closing_week3').value),
                    parseInt(document.getElementById(x + ' closing_week4').value)
                ]
            };
            x+=1;
        }
    ...
    var initMixedWidget5 = function() {
        ...
        [].slice.call(charts).map(function(element) {
            ...
            var lead_week1 = parseInt(document.getElementById('lead_week1').value);
            ...
            var options = {
                series: [{
                    name: 'Net Profit',
                    data: [lead_week1, lead_week2, lead_week3, lead_week4]
                }],
                chart: {
                    fontFamily: 'inherit',
                    type: 'area',
    ...
    var initMixedWidget6 = function() {
        ...
        [].slice.call(charts).map(function(element) {
            ...
            var closing_week1 = parseInt(document.getElementById('closing_week1').value);
            ...
            var options = {
                series: [{
                    name: 'Net Profit',
                    data: [closing_week1, closing_week2, closing_week3, closing_week4]
                }],
                chart: {
                    fontFamily: 'inherit',
                    type: 'area',
