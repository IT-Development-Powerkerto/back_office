...
var KTWidgets = function () {
    ...
    var initChartsWidget1 = function() {
        ...
        var omset_su = (parseInt(document.getElementById('omset_su').value)/1000000).toFixed(1);
        var omset_mo = (parseInt(document.getElementById('omset_mo').value)/1000000).toFixed(1);
        var omset_tu = (parseInt(document.getElementById('omset_tu').value)/1000000).toFixed(1);
        var omset_we = (parseInt(document.getElementById('omset_we').value)/1000000).toFixed(1);
        var omset_th = (parseInt(document.getElementById('omset_th').value)/1000000).toFixed(1);
        var omset_fr = (parseInt(document.getElementById('omset_fr').value)/1000000).toFixed(1);
        var omset_sa = (parseInt(document.getElementById('omset_sa').value)/1000000).toFixed(1);

        var advertising_su = (parseInt(document.getElementById('advertising_su').value)/1000000).toFixed(1);
        var advertising_mo = (parseInt(document.getElementById('advertising_mo').value)/1000000).toFixed(1);
        var advertising_tu = (parseInt(document.getElementById('advertising_tu').value)/1000000).toFixed(1);
        var advertising_we = (parseInt(document.getElementById('advertising_we').value)/1000000).toFixed(1);
        var advertising_th = (parseInt(document.getElementById('advertising_th').value)/1000000).toFixed(1);
        var advertising_fr = (parseInt(document.getElementById('advertising_fr').value)/1000000).toFixed(1);
        var advertising_sa = (parseInt(document.getElementById('advertising_sa').value)/1000000).toFixed(1);
    ...
    var initChartsWidget12 = function() {
        ...
        for(let i=0; i<product_count; i++){
            ...
            matchedData[i] = {
                ...
                name: document.getElementById('product ' + x).value,
                data: [
                    parseInt(document.getElementById(x + ' closing_su').value),
                    parseInt(document.getElementById(x + ' closing_mo').value),
                    parseInt(document.getElementById(x + ' closing_tu').value),
                    parseInt(document.getElementById(x + ' closing_we').value),
                    parseInt(document.getElementById(x + ' closing_th').value),
                    parseInt(document.getElementById(x + ' closing_fr').value),
                    parseInt(document.getElementById(x + ' closing_sa').value)
                ]
            };
            x+=1;
        }
    ...
    var initMixedWidget5 = function() {
        ...
        [].slice.call(charts).map(function(element) {
            ...
            var lead_su = parseInt(document.getElementById('lead_su').value);
            var lead_mo = parseInt(document.getElementById('lead_mo').value);
            var lead_tu = parseInt(document.getElementById('lead_tu').value);
            var lead_we = parseInt(document.getElementById('lead_we').value);
            ...
            var options = {
                series: [{
                    name: 'Net Profit',
                    data: [lead_su, lead_mo, lead_tu, lead_we, lead_th, lead_fr, lead_sa]
                }],
                chart: {
                    fontFamily: 'inherit',
                    type: 'area',
    ...
    var initMixedWidget6 = function() {
        ...
        [].slice.call(charts).map(function(element) {
            ...
            var closing_su = parseInt(document.getElementById('closing_su').value);
            var closing_mo = parseInt(document.getElementById('closing_mo').value);
            var closing_tu = parseInt(document.getElementById('closing_tu').value);
            var closing_we = parseInt(document.getElementById('closing_we').value);
            ...
            var options = {
                series: [{
                    name: 'Net Profit',
                    data: [closing_su, closing_mo, closing_tu, closing_we, closing_th, closing_fr, closing_sa]
                }],
                chart: {
                    fontFamily: 'inherit',
                    type: 'area',
