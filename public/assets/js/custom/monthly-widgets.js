...
var KTWidgets = function () {
    ...
    var initChartsWidget1 = function() {
        ...
        var omset_jan = parseInt(document.getElementById('omset_jan').value)/1000000;
        var omset_feb = parseInt(document.getElementById('omset_feb').value)/1000000;
        var omset_mar = parseInt(document.getElementById('omset_mar').value)/1000000;
        var omset_apr = parseInt(document.getElementById('omset_apr').value)/1000000;
        var omset_may = parseInt(document.getElementById('omset_may').value)/1000000;
        var omset_jun = parseInt(document.getElementById('omset_jun').value)/1000000;
        var omset_jul = parseInt(document.getElementById('omset_jul').value)/1000000;
        var omset_aug = parseInt(document.getElementById('omset_aug').value)/1000000;
        var omset_sep = parseInt(document.getElementById('omset_sep').value)/1000000;
        var omset_okt = parseInt(document.getElementById('omset_okt').value)/1000000;
        var omset_nov = parseInt(document.getElementById('omset_nov').value)/1000000;
        var omset_des = parseInt(document.getElementById('omset_des').value)/1000000;

        var advertising_jan = parseInt(document.getElementById('advertising_jan').value)/1000000;
        var advertising_feb = parseInt(document.getElementById('advertising_feb').value)/1000000;
        var advertising_mar = parseInt(document.getElementById('advertising_mar').value)/1000000;
        var advertising_apr = parseInt(document.getElementById('advertising_apr').value)/1000000;
        var advertising_may = parseInt(document.getElementById('advertising_may').value)/1000000;
        var advertising_jun = parseInt(document.getElementById('advertising_jun').value)/1000000;
        var advertising_jul = parseInt(document.getElementById('advertising_jul').value)/1000000;
        var advertising_aug = parseInt(document.getElementById('advertising_aug').value)/1000000;
        var advertising_sep = parseInt(document.getElementById('advertising_sep').value)/1000000;
        var advertising_okt = parseInt(document.getElementById('advertising_okt').value)/1000000;
        var advertising_nov = parseInt(document.getElementById('advertising_nov').value)/1000000;
        var advertising_des = parseInt(document.getElementById('advertising_des').value)/1000000;
