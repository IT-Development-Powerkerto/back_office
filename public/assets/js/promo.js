$(function(){
    $('#clipboard').hide();
    $('#payment_method, #courier, #quantity, #product_promotion_id, #shipping_promotion_id, #admin_promotion_id, #province, #promotion_admin').on('change', function(){
        var name = $('#name').val();
        ...
        // console.log(shipping_promotion_id);
        ...
        var text = `Nama Pemesan: ${name}\nAlamat: ${address}\nProvinsi: ${province}\nKota/Kabupaten: ${city}\nKecamatan: ${subdistrict}\nNo. Tlp : ${whatsapp}\nProduk yang dipesan: ${product}\nJumlah Pesanan: ${quantity}\nKurir: ${courier}\nMetode: ${payment_method}\nTotal Pembayaran: ${price*quantity} - ${promo_product} (promo produk) + ${ongkir} (ongkir) - ${promo_ongkir} (potongan ongkir) + ${admin} (biaya admin COD) - ${promo_admin} (promo biaya admin COD) = ${total_payment}`;
        // console.log(text);
        $("#clipboard").val(text);
    });
});